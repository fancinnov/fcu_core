...
int main(int argc, char **argv) {
  ...
  odom=nh.subscribe<nav_msgs::Odometry>("/vins_estimator/odometry_003", 100, odomHandler);
  ...
  motion=nh.subscribe<geometry_msgs::PoseStamped>("/motion_003", 100, motionHandler);
